...
function barista(coffees){
  let arrangedArr = coffees.sort((a,b) => (a - b))
  let cleanTime = (coffees.length-1) * 2 
  let coffeeSum = 0

  for (let i = 0; i < coffees.length; i++){

    coffeeSum = coffees[i] + coffeeSum
      
  }

  return coffeeSum + cleanTime
}

console.log(barista([5,10,3,2]))
